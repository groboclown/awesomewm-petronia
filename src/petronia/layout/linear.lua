---------------------------------------------------------------------------
--- Specialized Tiled layouts module for awful
--- Essentially, it's the tiled layouts but with no master client.
--
...
local function do_tile(param, orientation)
    ...
    -- local master_count = t.master_count
...
tile.vertical = tile.right
tile.horizontal = tile.bottom
